...
| File | Contents |
|---|---|
| `compose.alfresco.yaml` | postgres, activemq, alfresco, transform-core-aio, solr6, control-center |
...
Shared project name, network, and named volumes are declared in the root file.
